          ...
          <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-md p-8 space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-black mb-6 space-y-1">
                ...
                <li>
                  Products purchased during a sale or promotion (unless
                  defective).
                </li>
              </ul>
              ...
              <p className="text-black leading-relaxed mb-4">
                ...
                instructions on how to return the item(s). You may be
                responsible for return shipping costs unless the return is due
                to our error.
              </p>
              <p className="text-black leading-relaxed mb-4">
                Upon receiving the returned item(s) and verifying their
                condition, we will process your refund. Refunds will be issued
                to the original payment method and may take{" "}
              ...
              <p className="text-black leading-relaxed">
                ...
                item, please follow the refund process and place a new order for
                the desired item.
              </p>
            </section>

            {/* Footer Note */}
            <div className="p-4 rounded-lg border w-fit mx-auto">
